...
export function MostPopular({ articles }: { articles: News[] }) {
    if (!articles.length) return null

    return (
        <section className="home-section py-8">
            <div className="section-header">
                <h2 className="home-section-title">Most Popular Articles</h2>
                    ...
                    return (
                        ...
                        >
                            <div className="relative aspect-[4/3] rounded-xl overflow-hidden bg-slate-100 border border-slate-200">
                                <div className="absolute top-2 left-2 z-10 w-6 h-6 rounded bg-red-600 text-white flex items-center justify-center text-[10px] font-bold shadow-sm">
                                    {index + 1}
                                </div>
                                {coverImage ? (
                                    <Image

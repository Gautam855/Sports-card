...
export const legacyRedirects: LegacyRedirect[] = [
    ...
    { source: '/index.php/category/sports-news/', destination: '/news', permanent: true },
    { source: '/index.php/category/cricket', destination: '/sports/cricket', permanent: true },
    { source: '/index.php/category/cricket/', destination: '/sports/cricket', permanent: true },
    { source: '/index.php/category/cricket/feed', destination: '/sports/cricket', permanent: true },
    { source: '/index.php/category/futbol', destination: '/sports/football', permanent: true },
    { source: '/index.php/category/futbol/', destination: '/sports/football', permanent: true },
    { source: '/index.php/category/nfl', destination: '/sports/nfl', permanent: true },
    { source: '/index.php/category/nfl/', destination: '/sports/nfl', permanent: true },

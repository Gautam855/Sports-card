...
const SITEMAP_SECTIONS: SitemapSection[] = [
    ...
    },
    {
        ...
        icon: Trophy,
        links: [
            { label: 'Football / Soccer', href: '/sports/football', description: 'Premier League, Champions League, La Liga' },
            { label: 'Cricket', href: '/sports/cricket', description: 'IPL, ICC World Cup, Test Cricket, T20s' },
            { label: 'Basketball (NBA)', href: '/sports/basketball', description: 'NBA scores, standings, playoffs & trades' },
            { label: 'Tennis', href: '/sports/tennis', description: 'Grand Slams, ATP, WTA Tour news' },
            { label: 'Formula 1', href: '/sports/f1', description: 'Grand Prix races, driver standings & F1 news' },
            { label: 'NFL', href: '/sports/nfl', description: 'Super Bowl, touchdowns & draft analysis' },
            { label: 'MLB (Baseball)', href: '/sports/mlb', description: 'World Series, home runs & team stats' },
            { label: 'Olympics', href: '/sports/olympics', description: 'Olympic games, medal tallies & athletes' },
        ],
    },
    {
